...
type User struct {
	...
	// 二级密码
	SecPassword string `bson:"secPassword" json:"secPassword" gorm:"column:secPassword;type:char(64);"`
	// 二级密码盐
	SecPasswordSalt string `bson:"secPasswordSalt" json:"secPasswordSalt" gorm:"column:secPasswordSalt;type:char(64);"`
